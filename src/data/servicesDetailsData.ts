    ...
    sections: [
      {
        ...
        items: [
          "Atmospheric Corrosion | Chemical Exposure | Abrasion and Mechanical Wear",
          "Moisture and Humidity | Marine and Offshore Environments",
          "Industrial and Aggressive Environments | High-Temperature Service Conditions",
        ],
      },
      {
        title: "Our Product Range Includes",
        items: [
          "Zinc-Rich Silicate & Epoxy Coatings | High-Build Epoxy & MIO Coatings",
          "Polyurethane & Polysiloxane Topcoats | Abrasion-Resistant & Modified Epoxy Coatings",
          "Food-Grade Epoxy Coatings | Silicone Aluminium & Silicone Acrylic Coatings",
          "High-Temperature Resistant (HR) Epoxy Coatings | CUI (Corrosion Under Insulation) Coatings",
          "Inert Polymeric Matrix Coatings | Epoxy Phenolic Coatings",
          "Epoxy Tank Linings | Direct-to-Metal (DTM) & Primer-Cum-Finish Coatings",
          "Anti-Fouling Coatings | Zinc Phosphate Primers | Alkyd & Enamel Coatings",
        ],
      },
      {
        title: "Applications & Industries",
        items: [
          "Structural Steel & Steel Fabrication | Valves & Process Equipment",
          "Wind Energy Structures & Components | Oil & Gas Facilities",
          "Pipelines & Pipeline Infrastructure | Storage & Process Tanks",
          "Industrial Machinery & Equipment | Power & Energy Projects",
          "Infrastructure Projects | Pre-Engineered Buildings (PEB)",
