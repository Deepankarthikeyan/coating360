  ...
  services: [
    {
      ...
      text: "Comprehensive industrial protective coating systems for new construction, maintenance, refurbishment and repair across demanding environments.",
    },
    {
      id: "02",
      title: "Marine Paints & Coatings",
      text: "High-performance marine paints and protective coating solutions for seawater, humidity, salt spray and aggressive marine environments.",
    },
    {
      id: "03",
      title: "Fireproof & Intumescent Coatings",
      text: "Fireproof and intumescent coating application services for structural steel with thickness-controlled application and quality monitoring.",
    },
    {
      id: "04",
      title: "Industrial & Commercial Floor Coatings",
      text: "Complete epoxy, PU and heavy-duty industrial flooring solutions for warehouses, factories, workshops and chemical-resistant environments.",
    },
    {
      id: "05",
      title: "Blasting Equipment & Abrasives",
      text: "Abrasive blasting equipment, accessories and industrial abrasives for surface preparation across industrial and marine applications.",
    },
    {
      id: "06",
      title: "Paint Spray Equipment – Sales & Services",
      text: "Professional paint spraying equipment, accessories, pumps, spare parts, maintenance, servicing and technical guidance.",
    },
    {
      id: "07",
      title: "Paint Blasting & Coating Application Services",
      text: "Professional abrasive blasting, surface preparation and industrial coating application for new construction and asset protection projects.",
    },
    {
      id: "08",
      title: "Coating Inspection Services",
      text: "Coating inspection and quality control including WFT/DFT measurement, adhesion testing, holiday detection and documentation.",
    },
  ],
  whyChoose: {
