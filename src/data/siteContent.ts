...
export const siteContent = {
  ...
  images: {
    ...
    serviceCards: [
      ...
      "/assets/img/agh/services/intumescent-fireproofing.jpg",
      "/assets/img/agh/services/industrial-flooring.jpg",
      "/assets/img/agh/services/abrasives.jpg",
      "/assets/img/agh/services/blasting-equipments.jpg",
      "/assets/img/agh/services/sprayer-equipments.jpg",
      "/assets/img/agh/services/painting-services.jpg",
      "/assets/img/agh/services/coating-inspection.jpg",
    ],
    abrasiveSamples: [
      { label: "Garnet", image: "/assets/img/agh/page04_img2.jpeg" },
      { label: "Aluminum Oxide", image: "/assets/img/agh/page04_img3.jpeg" },
      { label: "Copper Slag", image: "/assets/img/agh/page05_img1.jpeg" },
      { label: "Steel Shot", image: "/assets/img/agh/page07_img1.jpeg" },
    ],
    news: [
  ...
  services: [
    {
      ...
      text: "High performance coatings for steel, infrastructure and industrial assets.",
    ...
    },
    {
      ...
      text: "Passive fire protection solutions that enhance safety and structural integrity in critical environments.",
      icon: "ri-fire-fill",
    },
    {
      id: "04",
    ...
    },
    {
      id: "05",
      title: "Abrasives",
      text: "Premium blasting abrasives for superior surface preparation and performance.",
      icon: "ri-settings-3-fill",
      variant: "abrasives",
    },
    {
      id: "06",
      title: "Blasting Equipments",
      text: "Reliable blasting equipment for surface preparation and corrosion control.",
      icon: "ri-tools-fill",
    },
    {
      id: "07",
      title: "Sprayer Equipments",
      text: "High quality spray equipment for precise and efficient coating application.",
      icon: "ri-contrast-drop-2-fill",
    },
    {
      id: "08",
      title: "Painting Services",
      text: "Expert application services delivering quality finishes on time, every time.",
      icon: "ri-brush-fill",
    },
    {
      id: "09",
