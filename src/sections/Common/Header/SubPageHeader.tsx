...
const SubPageHeader = () => {
  ...
  return (
    <div className="header-decoration">
          ...
          <div className="widget widget-about footer-widget">
            <div className="footer-logo footer-img site-brand-logo">
              <Link to="/" onClick={() => setIsSideBarOpen(false)}>
                <img src={brand.headerLogo} alt={brand.name} />
              </Link>
            </div>
                ...
                <div className="recent-post" key={item.title}>
                  <div className="media-body">
                    <h4 className="post-title">
                      <Link className="text-inherit" to={homeHref("#blog-sec")} onClick={() => setIsSideBarOpen(false)}>
                        {item.title}
                      </Link>
                    </h4>
                    <div className="recent-post-meta">
                      <Link to={homeHref("#blog-sec")} onClick={() => setIsSideBarOpen(false)}>{item.category}</Link>
                      <Link to={homeHref("#blog-sec")} onClick={() => setIsSideBarOpen(false)}>{item.date}</Link>
                    </div>
                  </div>
                </div>
              ))}
      ...
      <SubPageMobileMenu isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />
